...
public class FrmLgoodDatePicker extends JFrame implements DateChangeListener, InputMethodListener {
	...
	private void initComponents() {
		...
		dpPrueba1.getComponentToggleCalendarButton().setText("");
		dpPrueba1.getComponentToggleCalendarButton().setIcon(new ImageIcon("C:\\Users\\onkil\\Pictures\\iconedit.png"));
		...
		DateTimeFormatter formatoLocal = DateTimeFormatter.ofPattern("dd-MM-uuuu");
	...
	public void dateChanged(DateChangeEvent arg0) {
		...
		txtMostrar.setText(dpPrueba1.getDateStringOrEmptyString());
	}
